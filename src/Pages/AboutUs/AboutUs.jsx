...
const AboutUs = () => {
  ...
  <div className="container m-auto py-24 xl:pt-44">
      ...
      <section className="about-section mb-8">
        <h1 className="text-4xl font-bold mb-4">About Delivery Express</h1>
        <p className="text-xl font-bold">
          Welcome to Delivery Express, where we are committed to revolutionizing the parcel delivery experience.
        </p>
        <p className="text-lg font-semibold mt-2">
          Our mission is to provide a seamless, efficient, and secure platform for users to send and receive parcels.
          We understand the importance of timely and reliable deliveries, and that's why we've crafted Delivery Express
